...
<div style={{textAlign: 'center'}}>
  <img style={{boxShadow: '10px 10px 10px #888888'}} src="https://images.unsplash.com/photo-1505731324189-3d0afbeafcbf?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2396&q=80" />
</div>

## Content
- [Content](#content)
- [Babies, Kids, Parenting 👪👪👪👪](#babies-kids-parenting-)
- [Health 💊💊💊💊](#health-)
- [Insurance 🪂🪂🪂🪂](#insurance-)
- [Law and Order ⚖️⚖️⚖️⚖️](#law-and-order-️️️️)
- [News 📰📰📰📰](#news-)
- [Norwegian Language 🇳🇴🇳🇴🇳🇴🇳🇴](#norwegian-language-)
- [Personal Finance 💰💰💰💰](#personal-finance-)
- [Real Estate and Renting 🏠🏠🏠🏠](#real-estate-and-renting-)
- [Misc 🗑️🗑️🗑️🗑️](#misc-️️️️)



## Babies, Kids, Parenting 👪👪👪👪

[Bilingual Family](https://bilingualfamily.eu/) - Supporting parents and educators of bilingual children.

[Bilingual Picturebook](https://www.bilingual-picturebooks.org/en/home) - The aim of the project is to create a database for bilingual picture book stories written by children, for children.
...
[Multilingual Parenting](https://multilingualparenting.com/) - Blog and resources about multilingual parenting.

## Health 💊💊💊💊

[Helsenorge](https://www.helsenorge.no/) - Is a public website for residents of Norway. Helsenorge.no is divided into two main parts: 1)information pages, where you will find quality-assured health information on a number of topics; 2) self-service solutions, where you have access to various health-related online services
...
[Rankavis](https://www.rankavis.no/) - RankAvis is a solution that aims to organize and provide a better overview of news articles published in the Norwegian media spectrum.  [Sources covered.](https://www.rankavis.no/kilder).
